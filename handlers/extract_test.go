...
func TestExtractHandler_ValidFile(t *testing.T) {
	...
	filePath := "../media/SampleVideo_1280x720_1mb.mp4" // Path to a sample video file, make sure this file exists in your test environment. May have to add to repo undecided on how to handle for the time being.
